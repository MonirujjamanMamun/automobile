      ...
      <form action="" className="space-y-6">
        <div className="space-y-2 text-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring bg-gray-200 "
          />
        </div>
        <div className="space-y-2 text-sm">
        ...
        <div className="mb-20 mt-10 text-center">
          <button className="py-4 px-5 bg-gray-700 rounded-tl-lg rounded-br-lg font-bold text-gray-300 hover:bg-gray-400 hover:text-black uppercase">
            log in
          </button>
        </div>
