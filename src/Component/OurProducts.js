    ...
    return (
        <div className='container mx-auto'>
            <div className='text-center my-10'>
                ...
                <h1 className='text-3xl text-black font-bold my-1'>Our Products</h1>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <div className='bg-white text-center rounded-md text-black p-9 border-b-8 border-gray-600'>
                    <img className='mx-auto p-3 my-3' src={bull2} />
                    <h3 className='text-2xl mb-2 font-bold'>Largest Dealership</h3>
                    <p>AutoImage is aliquip consequat to duis elit tam cillum dolore fugiat null pariatur excepteur sint for occaecat.</p>
                </div>
                <div className='bg-white text-center rounded-md text-black p-3 border-b-8 border-gray-600'>
