  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <img
            className="mx-auto p-3 my-3 rounded-md"
            src={bull1}
            alt="bike1"
          />
          ...
          <p>
            ...
            manufacturers in the world. Established in 1901.
          </p>
        </div>
        {/* card 2 */}
        <div
      ...
      <div className="mb-20 mt-10 text-center">
        <button className="uppercase py-4 px-3 bg-gray-700 rounded-tl-lg rounded-br-lg font-bold text-gray-300 hover:bg-gray-400 hover:text-black">
          See all producs
        </button>
      </div>
    </div>
