    ...
    return (
        <div className='container mx-auto mt-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                <div className='bg-gray-100 text-center rounded-md text-black p-9 sm:mx-2'>
                ...
                <div className='bg-white text-center rounded-md text-black p-9 border-b-8 border-gray-400 sm:mx-2'>
