      ...
      <div className="container mx-auto mt-6">
        ...
        >
          ...
          <div className="my-16 border-b-8 rounded-b-3xl border-gray-400">
            ...
            <h1 className="text-2xl text-black font-bold mt-2 mb-4">
              Our Advantages
            </h1>
          </div>
          <div></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div
            ...
            className="bg-gray-100 text-center rounded-md text-black p-3 sm:my-3"
          >
            <img className="mx-auto p-3 my-3" src={log1} alt="logo" />
          ...
          <div
            data-aos="zoom-in-up"
            data-aos-duration="3000"
            className="bg-white text-center rounded-md text-black p-3 border-b-8 border-gray-400 sm:my-3"
          >
            <img className="mx-auto p-3 my-3" src={log2} alt="logo" />
          ...
          <div
            ...
            className="bg-gray-100 text-center rounded-md text-black p-3 sm:my-3"
          >
            <img className="mx-auto p-3 my-3" src={log3} alt="logo" />
