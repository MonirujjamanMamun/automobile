...
const NavBar = () => {
  const menuItem = (
    <>
      <li>
        <Link className="font-bold text-lg text-white no-underline" to="/">
          HOME
        </Link>
      </li>
      <li>
        <Link className="font-bold text-lg text-white no-underline" to="/shop">
          SHOP
        </Link>
      </li>
      <li>
        <Link className="font-bold text-lg text-white no-underline" to="/news">
          NEWS
        </Link>
      </li>
      <li>
      ...
      <li>
        <Link className="font-bold text-lg text-white no-underline" to="/login">
          LOG IN
        </Link>
      </li>
      <li>
