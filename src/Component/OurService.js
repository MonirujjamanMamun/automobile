  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <div
        ...
        className="grid md:grid-cols-1 lg:grid-cols-5 lg:gap-x-0 items-center text-center"
      >
        <div></div>
        <div></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <img
            width={70}
            className="mx-auto p-3 my-3"
            src={service1}
            alt="service1"
          />
          <h3 className="text-2xl mb-2 font-bold">ONLINE BOOKING</h3>
          <p>
            You can book your bike online with minimum amount of Rs 10,000/- Get
            payment confirmation invoice on your E-mail.
          </p>
        </div>
        {/* card-2 */}
        <div
        ...
        >
          ...
          <p>
            Your bike needs servicing, do not waste time! Call us for servicing
            and Get the pick and drop facility at home.
          </p>
        </div>
        {/* card-3 */}
        <div
        ...
        >
          ...
          <p>
            Afraid of non refundable bookings. Get your booking done at home or
        ...
        >
          ...
          <p>
            Can not visit showroom or no time to pick your bike. Get your
            booking and delivery done at home. Just give us a call.
          </p>
        </div>
        {/* card-5  */}
        <div
        ...
        >
          ...
          <p>
            Want a Test Ride but do not have time to visit! Book a Free Test
            ride and get your Test Ride at home.
          </p>
        </div>
        {/* card-6  */}
        <div
        ...
        >
          ...
          <p>
            A-15, Block-1, Mathura Rd, Mohan cooperative industrial estate, New
            Delhi-110044
          </p>
        </div>
      </div>
